...
from triangulate_corner_disks import triangulate_corner_disk_convex, triangulate_corner_disk_concave
from circle_tools import tangent_point_dd, tangent_point_ld, angle_between_points, cross_product
from corner_disks import disk_at_convex_corner, disk_at_concave_corner
from find_tangent_solution import find_tangent_solution
from feasible_disk_finder import feasible_disk_finder
from triangulate_3remainder_region import triangulate_3remainder_region
from triangulate_4remainder_region import triangulate_4remainder_region
...
class Polygon(BaseModel):
    ...
    def plot_polygon(self):
        plotting.plot_polygon(self.boundary)
        for hole in self.holes:
            plotting.plot_polygon(hole)
    ...
    def pack_disks_in_polygon(self, boundary: list):
        ...
        # Recursive case
            ...
            if len(min_tangent_elements) > 1:
                ...
                plotting.plot_disk(solution_disk, color='magenta')
...
###### CORNER DISK METHODS ######
    ...
    def add_corner_disk(self, edge: Edge, next_edge: Edge):
        ...
        if crossproduct < 0 and not math.isclose(crossproduct, 0, abs_tol=tolerance):
            ...
            plotting.plot_disk(d, color="green")
            ...
            plotting.plot_disk(d1, color="green")
            plotting.plot_disk(d2, color="green")
